...
PROJECT = {"analysis_type": "var", "category": "Stochastic Models & Market Risk", "columns": ["date", "portfolio_return"], "methods": ["수익률 하위 분위수로 Historical VaR를 계산하고 더 나쁜 손실 평균을 ES로 둔다.", "예외 횟수와 예외율을 같이 보여 모델 검증의 첫 단계를 만든다.", "표본은 손익 분포와 예외율 계산을 설명하도록 구성한 합성 수익률이다."], "module_name": "var_backtesting_baseline", "objective": "포트폴리오 수익률 표본에서 Historical VaR와 Expected Shortfall을 추정하고 예외 발생률을 확인한다.", "question": "과거 손익 분포로 추정한 VaR는 실제 손실 예외를 어느 정도 설명하는가?", "rows": [["2026-01-02", 0.006], ["2026-01-03", -0.004], ["2026-01-04", 0.003], ["2026-01-05", -0.011], ["2026-01-06", 0.008], ["2026-01-07", -0.017], ["2026-01-08", 0.002], ["2026-01-09", -0.006], ["2026-01-10", 0.009], ["2026-01-11", -0.024], ["2026-01-12", 0.004], ["2026-01-13", -0.003], ["2026-01-14", 0.005], ["2026-01-15", -0.014], ["2026-01-16", 0.007], ["2026-01-17", -0.009], ["2026-01-18", 0.011], ["2026-01-19", -0.031], ["2026-01-20", 0.006], ["2026-01-21", -0.012]], "sample_name": "portfolio_returns.csv", "title_en": "Market Risk VaR Backtesting", "title_ko": "시장 리스크 VaR 백테스팅"}
